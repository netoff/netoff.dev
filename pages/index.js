          ...
          <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg shadow-2xl bg-white mx-6 lg:mx-0 z-10" style={{backgroundColor: "rgba(255, 255, 255, .7)"}}>    
            <div className="p-4 md:p-12 text-center lg:text-left">
              ...
              <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                ...
                Serbia (
                  <a className='link' href="https://en.wikipedia.org/wiki/Central_European_Time" target="_blank">CET - Central European Time</a>/
                  <a className='link' href="https://en.wikipedia.org/wiki/UTC%2B01:00" target="_blank">UTC+1</a>
                )
              </p>
              ...
              */}
              ...
              <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                ...
                {[
                  ...
                  'heroku',
                    ...
                    <Image title={lang} alt={lang} width="32" height="32" className="skill" src={`https://cdn.jsdelivr.net/gh/devicons/devicon/icons/${lang}/${lang}-original.svg`} />
                  )}
              ...
              <div className="pt-8 pb-4">
                ...
                &nbsp;or&nbsp;
                <a href="https://calendly.com/netoff/15min" target="blank" className="button">
                  Schedule a Meeting
                </a>
              </div>
