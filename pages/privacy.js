...
export default function Privacy() {
  ...
  return (
    <div className="prose mx-auto bg-white p-8">
      <Head>
        <title>netoff | Privacy Policy</title>
      </Head>
      <Link href={``}>
      ...
      <p>
        Your privacy is important to us. It is netoff&#39;s policy to respect your privacy and
        ...
        <a href="https://netoff.dev">https://netoff.dev</a>, and other sites we own and operate.{' '}
      </p>
      <p>This policy is effective as of 22 April 2022 and was last updated on 22 April 2022. </p>
      ...
      <ul>
        ...
        <li>
          ...
          for example, IT service providers, data storage, hosting and server providers,
