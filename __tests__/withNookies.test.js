import withNookies, { COOKIE_DEFAULTS } from '../components/ConsentProvider/withNookies'
...
describe('withNookies', () => {
  let Component = ({ consent, children, setConsent }) => {
  ...
  let ComponentWithNookies = withNookies(Component)
